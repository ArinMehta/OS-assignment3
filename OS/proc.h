...
struct proc {
    ...
    int             syscall_count;  // Count of number of syscalls made by this process
    int             tickets;        // Number of tickets assigned to this process
    int             boostsleft;     // Number of boosts left for a process
    int             runticks;       // Number of timer ticks this process has been scheduled
    uint            duration_of_sleep;     // this is the amount of ticks until the process should remain in SLEEP
